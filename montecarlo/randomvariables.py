...
def get_random_variables(dim):
    ...
    if dim == 1:
        rvs = [
            ...
            MultivariateDistribution([GaussianMixture([0, 0], [1, 2], [0.1, 0.9])], label="1dGM5"),
            ...
            MultivariateDistribution([GaussianMixture([0, 4], [1, 0.5], [0.9, 0.1])], label="1dGM11"),
            MultivariateDistribution([GaussianMixture([0, 4], [1, 0.5], [0.7, 0.3])], label="1dGM12"),
            MultivariateDistribution([GaussianMixture([0, 4], [1, 0.5], [0.5, 0.5])], label="1dGM13"),
            MultivariateDistribution([GaussianMixture([0, 4], [1, 0.5], [0.3, 0.7])], label="1dGM14"),
            MultivariateDistribution([GaussianMixture([0, 4], [1, 0.5], [0.1, 0.9])], label="1dGM15"),
            MultivariateDistribution([GaussianMixture([0, 1], [1, 3], [0.9, 0.1])], label="1dGM16"),
            MultivariateDistribution([GaussianMixture([0, 1], [1, 3], [0.7, 0.3])], label="1dGM17"),
            MultivariateDistribution([GaussianMixture([0, 1], [1, 3], [0.5, 0.5])], label="1dGM18"),
            MultivariateDistribution([GaussianMixture([0, 1], [1, 3], [0.3, 0.7])], label="1dGM19"),
            MultivariateDistribution([GaussianMixture([0, 1], [1, 3], [0.1, 0.9])], label="1dGM20"),
        ]
    # if dim == 2:
    #     rvs = [
