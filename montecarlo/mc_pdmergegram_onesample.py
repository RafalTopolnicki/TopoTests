...
from pdmegregram import PDMergegram_onesample
import pandas as pd
import logging
...
def run_mc(rvs, args):
    ...
    outputfilename = f"pdmergegram_dim={args.dim}_n={args.n}_order={args.order}_p={args.p}_null={null_distr_label}.csv"
