...
from pdlltest import PDLLTest_onesample
import pandas as pd
import logging
...
def run_mc(rvs, args):
    ...
    outputfilename = f"dplltest_dim={args.dim}_n={args.n}_persistence_dim={args.persistence_dim}_null={null_distr_label}.csv"
