...
rvs = [MultivariateDistribution([st.norm(), st.norm(), st.norm(), st.norm(), st.norm()], label='N01xN01xN01xN01xN01'),
       MultivariateDistribution([st.t(df=3), st.t(df=3), st.t(df=3), st.t(df=3), st.t(df=3)], label='T3xT3xT3xT3xT3'),
       MultivariateDistribution([st.t(df=5), st.t(df=5), st.t(df=5), st.t(df=5), st.t(df=5)], label='T5xT5xT5xT5xT5'),
       MultivariateDistribution([st.t(df=10), st.t(df=10), st.t(df=10), st.t(df=10), st.t(df=10)], label='T10xT10xT10xT10xT10'),
       MultivariateDistribution([st.norm(), st.t(df=5), st.t(df=5), st.t(df=5), st.t(df=5)], label='N01xT5xT5xT4xT5'),
       MultivariateDistribution([st.norm(), st.norm(), st.t(df=5), st.t(df=5), st.t(df=5)], label='N01xN01xT5xT5xT5'),
       MultivariateDistribution([st.norm(), st.norm(), st.norm(), st.norm(), st.t(df=5)], label='N01xN01xN01xN01xT5'),
       MultivariateDistribution([st.laplace(), st.laplace(), st.laplace(), st.laplace(), st.laplace()], label='LapxLapxLapxLapxLap'),
       MultivariateDistribution([st.norm(), st.norm(), st.laplace(), st.laplace(), st.laplace()], label='N01xN01xLapxLapxLap')
      ]
