import numpy as np
from pdllmeanpdf import pdllmeanpdf_representation
...
class PDLLMeanPDFTest_onesample:
    def __init__(
        self,
        n: int,
        dim: int,
        ...
        self.representation = pdllmeanpdf_representation(persistence_dim=self.persistence_dim)
