import numpy as np
from pairdistance import  pairdistance_representation
...
class DistanceTest_onesample:
    def __init__(
        ...
        if method == "approximate":
            self.representation = pairdistance_representation(self.norm, mode="approximate")
        if method == "exact":
            self.representation = pairdistance_representation(self.norm, mode="exact")
