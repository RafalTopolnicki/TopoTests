...
def FuncQuads_fast(func2D, point, xlim, ylim, rounddig=4):
    """ Computes the probabilities of finding points in each 4 quadrant
    ...
    totInt= IntCdf(func2D, xlim[1], ylim[1], xlim[0], ylim[0])

    Qpp = IntCdf(func2D, xlim[1], ylim[1], point[0], point[1])
    ...
    # TODO:
    # * remove round
    # * remove xmin, xmax, ymin, ymax and replace it with lower and upper limit 
